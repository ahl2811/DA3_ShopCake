...
namespace ConsoleApp2.db
{
    class CakeDaoImp : CakeDao
    {
        ...
        public void insertCake(Cake cake)
        {
            ...
            {
                String query = "INSERT INTO dbo.CAKE (CAKE_ID, CATALOGUE_ID, CAKE_NAME, PRICE, IMAGE)" +
                " VALUES (@Id,@CatalogueId,@Name,@Price,@Image)";
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    command.Parameters.AddWithValue("@Image", cake.Image);
